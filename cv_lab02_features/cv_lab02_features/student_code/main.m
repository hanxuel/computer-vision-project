...
[corners1, H1] = extractHarrisCorner(imgBW1',0.0005);
[corners2, H2] = extractHarrisCorner(imgBW2',0.0005);
% % 
...
matches = matchDescriptors(descr1, descr2, 0.11);
% 
...
[f1,d1] = vl_sift(I1);
[f2,d2]=vl_sift(I2);
[matches1,scores]=vl_ubcmatch(d1,d2,20);
showFeatureMatches(img1, f1(1:2, matches1(1,:)), img2, f2(1:2, matches1(2,:)), 21);